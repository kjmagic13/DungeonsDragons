...
class WeaponsControllerTest < ActionController::TestCase
  ...
  test "should create weapon" do
    assert_difference('Weapon.count') do
      post :create, weapon: { attack: @weapon.attack, damage: @weapon.damage, name: @weapon.name, player_id: @weapon.player_id }
    end
  ...
  test "should update weapon" do
    patch :update, id: @weapon, weapon: { attack: @weapon.attack, damage: @weapon.damage, name: @weapon.name, player_id: @weapon.player_id }
    assert_redirected_to weapon_path(assigns(:weapon))
  end
